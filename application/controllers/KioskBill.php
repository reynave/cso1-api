...
class KioskBill extends CI_Controller
{
    ...
    function index()
    {
        ...
        if ($uuid) {
            ...
            c.id, c.kioskUuid, c.itemId, c.price, c.discount, c.barcode, c.isSpecialPrice , c.isFreeItem, c.note,
            i.description, i.shortDesc, i.images, c.originPrice
